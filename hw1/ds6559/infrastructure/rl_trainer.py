...
import sys
import time
from ds6559.infrastructure.atari_wrappers import ReturnWrapper

import gym
from gym import wrappers
import numpy as np
import torch
from ds6559.infrastructure import pytorch_util as ptu

from ds6559.infrastructure.utils import Path
from ds6559.infrastructure import utils
from ds6559.infrastructure.logger import Logger

from ds6559.agents.dqn_agent import DQNAgent
from ds6559.agents.sac_agent import SACAgent
from ds6559.infrastructure.dqn_utils import (
    get_wrapper_by_name,
...
class RL_Trainer(object):
    ...
    def __init__(self, params):
        ...
        if not (self.params['env_name'] == 'obstacles-ds6559-v0'):
            import matplotlib
            matplotlib.use('Agg')
    ...
    def collect_training_trajectories(self, itr, initial_expertdata, collect_policy, num_transitions_to_sample,
        ...
        if self.logvideo:
            ...
            train_video_paths = utils.sample_n_trajectories(self.env, collect_policy, range(MAX_NVIDEO), MAX_VIDEO_LEN,
                                                            True)
