...
from ds6559.infrastructure.dqn_utils import MemoryOptimizedReplayBuffer, PiecewiseSchedule
from ds6559.policies.argmax_policy import ArgMaxPolicy
from ds6559.critics.dqn_critic import DQNCritic
...
class DQNAgent(object):
    ...
    def step_env(self):
        ...
        if perform_random_action:
            ...
            o_all = self.replay_buffer.encode_recent_observation()
            action = self.actor.get_action(o_all)
